...
class Purl
{
    ...
    {     
        ...
        echo "<pre> here ".print_r(array($this->_url, $query, $headers, $this->_options), true)."</pre>";
		$temp = $this->_call($query, $this->_info['request_header'] = $headers); 
        return $temp;
    }
    ...
    {        
        ...
        echo '<pre>'.print_r(array($this->_result, $this->_url, $this->_info['http_code'], $context, $reporting), true).'</pre>';    
        // on failure
